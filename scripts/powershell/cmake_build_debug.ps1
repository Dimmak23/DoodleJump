...
# cmake --build build --config Debug --target SDL2_connector -j 8 -v
# cmake --build build --config Debug --target TL -j 8 -v
# cmake --build build --config Debug --target SDL2_connector TL -j 8 -v