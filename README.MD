...
Specify configuration (Debug or Release) with generator (Ninja, MinGW Makefiles or Unix Makefiles, Mirosoft Visual Studio 17 2022 - however no such option for linux builts)
